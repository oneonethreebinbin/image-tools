...
const conversionMode = ref('md-to-word')
...
// Parse tokens into docx elements (async for mermaid support)
...
/* Mermaid container styling in preview */
.preview-area :deep(.mermaid-container) {
    text-align: center;
    margin: 12px 0;
    padding: 8px;
    background: #FAFAFA;
...
.preview-area :deep(.mermaid-container svg) {
    max-width: 100%;
    height: auto;
}
